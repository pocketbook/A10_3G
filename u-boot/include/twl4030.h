...
#define REG_USB_DTCT_CTRL		(TWL4030_BASEADD_MAIN_CHARGE + 0x002)
#define USB_SW_CHRG_CTRL    (TWL4030_BASEADD_MAIN_CHARGE + 0x003)
//&*&*&*HC2_20110304, Add offmode charging
//&*&*&*20110304_Aimar ++
#define REG_BCIA_CTRL       (TWL4030_BASEADD_MAIN_CHARGE + 0x004)
#define REG_TWL4030_BCI_MESBAT_EN       0x01
//&*&*&*20110304_Aimar --
...
#define CTRL1 0x0000
#define CTRL2	0x0001
#define RTSELECT_LSB 0x0002
#define RTSELECT_MSB 0x0003
#define RTAVERAGE_LSB 0x0004
#define RTAVERAGE_MSB 0x0005
#define SW1SELECT_LSB 0x0006
#define SW1SELECT_MSB 0x0007
#define SW1AVERAGE_LSB 0x0008
#define SW1AVERAGE_MSB 0x0009
#define SW2SELECT_LSB 0x000A
#define SW2SELECT_MSB 0x000B
#define SW2AVERAGE_LSB 0x000C
#define SW2AVERAGE_MSB 0x000D
#define ACQUISITION 0x000F
#define USBREF_LSB 0x0010
#define USBREF_MSB 0x0011
#define CTRL_SW1 0x0012
#define CTRL_SW2 0x0013
#define RTCH0_LSB 0x0017
#define RTCH0_MSB 0x0018
#define GPCH0_LSB 0x0037
#define GPCH0_MSB 0x0038
#define GPCH8_LSB 0x0047
#define GPCH8_MSB 0x0048
#define GPCH9_LSB 0x0049
#define GPCH9_MSB 0x004A
#define GPCH12_LSB 0x004F
#define GPCH12_MSB 0x0050
#define MADC_ISR1 0x0061
#define MADC_IMR1 0x0062
#define MADC_SIR 0x0065
#define MADC_EDR 0x0066
#define MADC_SIH_CTRL 0x0067
//&*&*&*20101201_Peter --
/*
...
#define CLEARGPIODATAOUT2	0xA2 
#define CLEARGPIODATAOUT3	0xA3 
#define SETGPIODATAOUT1	0xA4 
#define SETGPIODATAOUT2	0xA5 
#define SETGPIODATAOUT3	0xA6 
...
/* CFG_P123_TRANSITION Reg */
#define SEQ_OFFSYNC		(0x1 << 0)

/* P1_SW_EVENTS Reg */
#define PWR_STOPON_POWERON	(0x1 << 6)
#define PWR_DEVOFF				(0x1 << 0)

/* PIH_ISR_P1 Reg */
#define REG_PIH_ISR_P1	(TWL4030_BASEADD_PIH + 0x01)

/* PWR_ISR1 Reg */
#define REG_PWR_ISR1	(TWL4030_BASEADD_INT + 0x00)

#define RTC_STATUS_REG 0x2A
#define RTC_INTERRUPTS_REG 0x2B
#define IT_ALARM (0x1 << 3)
...
#if defined(CONFIG_TWL4030_MADC_VBAT)
