...
#define CONFIG_CHECK_POCKET_BOOK_ENV	1
#define CONFIG_BOOT_RAMDISK_INITRD	1
#define CONFIG_CHECK_SECOND_BOOTLOADER	1
#define CONFIG_DEBUG_SWITCH	1	
#define CONFIG_MENUKEY	0x20	//&*&*&*SJ_20110926, add check menu key (space key (0x20)).
...
//#define CONFIG_TWL4030_MADC_VBAT    1
#define CONFIG_MAX17043_GAUGE       1

//&*&*&*HC1_20110615, max17043 experimentation log
//#define CONFIG_DISCHARGING_EXPERIMENTATION 1
//#define CONFIG_MAX17043_DEBUG_MESSAGE_FORMAT 1
//&*&*&*HC2_20110615, max17043 experimentation log 
...
#define CONFIG_CHARGING_REDUCE_SYS_LOAD 1
#define CONFIG_KEY_LIGHT_NOTIFICATION 1
...
#define CFG_FASTBOOT_PREBOOT_KEY1         0x00		/* 'Vol -'(EP10 Hardware) */
...
//#define CFG_INAND_UPDATE_MODE_PREBOOT_KEY1	 0x0a	/* 'Search Key' (EP10 Hardware) */
#define CFG_INAND_UPDATE_MODE_PREBOOT_KEY1	 0x01	/* 'Vol +'(for EVT3 according to EP10 Artwork v1.2.)*/
...
//&*&*&*20110620_SJ1
	...
	#define CONFIG_INITRAMFS_BOOTARGS_TFT_EMMC_BOOT	"console=ttyO0,115200n8 rootwait mem=509M init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:4M androidboot.console=ttyO0"
	#define CONFIG_INITRAMFS_BOOTARGS_TFT_EMMC_GPS_UART_BOOT "console=ttyO2,115200n8 rootwait mem=509M init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:4M androidboot.console=ttyO2"
	#define CONFIG_INITRAMFS_BOOTCOMMAND_EMMC  "mmcinit 1; mmc 1 read 82000000 300000 380000; mmc 1 read 83000000 1800000 100000; bootm 82000000 83000000"
#endif
//&*&*&*20110620_SJ2

#define CONFIG_BOOTARGS_TFT_NAND_BOOT	"console=ttyO0,115200n8 root=/dev/mtdblock6 rw rootfstype=yaffs2 init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:4M androidboot.console=ttyO0"
#define CONFIG_BOOTARGS_TFT_NAND_GPS_UART_BOOT	"console=ttyO2,115200n8 root=/dev/mtdblock6 rw rootfstype=yaffs2 init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:4M androidboot.console=ttyO2" 
#define CONFIG_BOOTCOMMAND_NAND  "nand read 82000000 300000 380000; bootm 82000000"

#define CONFIG_BOOTARGS_TFT_EMMC_BOOT	"console=ttyO0,115200n8 root=/dev/mmcblk0p1 rw rootwait mem=509M init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:4M androidboot.console=ttyO0"
#define CONFIG_BOOTARGS_TFT_EMMC_GPS_UART_BOOT "console=ttyO2,115200n8 root=/dev/mmcblk0p1 rw rootwait mem=509M init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:4M androidboot.console=ttyO2"
#define CONFIG_BOOTCOMMAND_EMMC  "mmcinit 1; mmc 1 read 82000000 300000 310000; bootm 82000000"
	...
	#define CONFIG_BOOTARGS_TFT_SD1_BOOT "console=ttyO0,115200n8 root=/dev/mmcblk1p2 rw rootwait mem=509M init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:4M androidboot.console=ttyO0"
	#define CONFIG_BOOTARGS_TFT_SD1_GPS_UART_BOOT  "console=ttyO2,115200n8 root=/dev/mmcblk1p2 rw rootwait mem=509M init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:4M androidboot.console=ttyO2"
#else
	#define CONFIG_BOOTARGS_TFT_SD1_BOOT "console=ttyO0,115200n8 root=/dev/mmcblk0p2 rw rootwait mem=509M init=/init videoout=omap24xxvout videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:4M androidboot.console=ttyO0"
	#define CONFIG_BOOTARGS_TFT_SD1_GPS_UART_BOOT  "console=ttyO2,115200n8 root=/dev/mmcblk0p2 rw rootwait mem=509M init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:4M androidboot.console=ttyO2"
