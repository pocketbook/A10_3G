...
static int omap_start_ehc(struct ehci_hcd_omap *omap, struct usb_hcd *hcd)
{
	...
	printk("omap_start_ehc kernel 2.6.35 V0.8a [10/03/2011]  \n");
...
// V0.7 [09/02/2011] Fix HW-ID problem in DVT1
// V0.8 [09/30/2011] use mdelay(1) for usb auto-suspend
// V0.8a [10/03/2011] Disable usb auto-suspend
//*****************//