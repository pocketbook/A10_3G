...
#include <asm/sizes.h>	//&*&*&*SJ_20110706, merge #change,14303
...
//&*&*&*SJ1_20110706, merge #change,14303
#define OTG_SYSCONFIG			0x404
#define OTG_SYSC_SOFTRESET		BIT(1)

#define OTG_FORCESTDBY			0x414
//&*&*&*SJ2_20110706, merge #change,14303
...
//&*&*&*SJ1_20110511, Add EP Series PID & VID.
#if defined (CONFIG_USB_VENDOR_ID_FOXCONN)
/* Foxconn EP Series */
#define OMAP_VENDOR_ID        0x0489
#if defined (CONFIG_USB_PRODUCT_ID_EP6)
#define OMAP_UMS_PRODUCT_ID		0xE114
#define OMAP_UMS_ADB_PRODUCT_ID		0xE104

#elif defined (CONFIG_USB_PRODUCT_ID_EP10)
#define OMAP_UMS_PRODUCT_ID		0xE115
#define OMAP_UMS_ADB_PRODUCT_ID		0xE105

#elif defined (CONFIG_USB_PRODUCT_ID_EP5A)
#define OMAP_UMS_PRODUCT_ID		0xE116
#define OMAP_UMS_ADB_PRODUCT_ID		0xE106

#else
#error Please configure EP Series product ID.   
#endif
...
#endif /* End CONFIG_USB_VENDOR_ID_FOXCONN */
//&*&*&*SJ2_20110511, Add EP Series PID & VID.
...
static struct android_usb_platform_data andusb_plat = {
	...
	.product_id		= OMAP_UMS_PRODUCT_ID,
//&*&*&*SJ1_20110527, Add EP Series PID & VID.
#if defined (CONFIG_USB_VENDOR_ID_FOXCONN)
	#if defined (CONFIG_USB_PRODUCT_ID_EP6)
	.manufacturer_name	= "PocketBook International",
	.product_name		= "PocketBook Vision",
	#elif defined (CONFIG_USB_PRODUCT_ID_EP10)
	.manufacturer_name	= "PocketBook International",
	.product_name		= "PocketBook A10",
	#elif defined (CONFIG_USB_PRODUCT_ID_EP5A)
	.manufacturer_name	= "PocketBook International",
	.product_name		= "PocketBook A7",
	#endif	
#else
	.manufacturer_name	= "Texas Instruments Inc.",
	.product_name		= "OMAP-3/4",
#endif
//&*&*&*SJ2_20110527, Add EP Series PID & VID.
...
//&*&*&*SJ1_20110527, Add EP Series PID & VID.
#if defined (CONFIG_USB_VENDOR_ID_FOXCONN)
	.vendorDescr    = "PocketBook International",
#else
...
void __init usb_musb_init(struct omap_musb_board_data *board_data)
{
	...
	void __iomem *otg_base;	//&*&*&*SJ_20110706, merge #change,14303
	...
	if (drv) {
		...
		if (plat->is_usb_active)
			if (!pdata->is_usb_active(dev)) {
				...
				__raw_writel(0x1, base + OTG_FORCESTDBY);	//&*&*&*SJ_20110706, merge #change,14303
				pdata->device_idle(pdev);
				break;
				...
				__raw_writel(0x0, base + OTG_FORCESTDBY);	//&*&*&*SJ_20110706, merge #change,14303
