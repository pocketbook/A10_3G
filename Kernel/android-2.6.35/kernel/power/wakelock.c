...
//&*&*&*HC1_20111018, Add for keypad wakeup
#if defined (CONFIG_TWL4030_KEYPAD_WAKEUP) 
		if ((requested_suspend_state != PM_SUSPEND_ON) && (g_wakeup_reason == WKUP_KEYPAD))
			send_event = 1;
#endif		
//&*&*&*HC2_20111018, Add for keypad wakeup

//&*&*&*HC1_20111206, Modify for SIM card wakeup
#if defined (CONFIG_SIM_CARD_WAKEUP) 
		// set wakelock to wait the sim card detection complete
		if(g_wakeup_reason == WKUP_SIM_CARD)
